...
public class OrderProduct extends WebTest {
    ...
    @When("^user goes to address page and clicks to proceed$")
    public void user_goes_to_address_page_and_clicks_to_proceed() throws Throwable {
        addressPage.proceedToCheckout();
    }

    @When("^user confirms the terms and services and click to proceed$")
    ...
    @When("^user pays the amount for the T-Shirt$")
    public void user_pays_the_amount_for_the_T_Shirt() throws Throwable {
        ...
        referenceNumber = paymentPage.getOrderReferenceNumber();
    }
    ...
    public void then_user_should_be_able_to_validate_order() {
        ...
        Assert.assertTrue(orderHistory.isOrderPresent(referenceNumber));
    }
